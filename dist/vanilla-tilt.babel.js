...
var VanillaTilt = function () {
  ...
  VanillaTilt.prototype.update = function update() {
    ...
    var defaultX = this.settings.resetToStarting ? this.settings.startX : 0;
    var defaultY = this.settings.resetToStarting ? this.settings.startY : 0;

    this.element.style.transform = "perspective(" + this.settings.perspective + "px) " + "rotateX(" + (this.settings.axis === "x" ? defaultX : values.tiltY) + "deg) " + "rotateY(" + (this.settings.axis === "y" ? defaultY : values.tiltX) + "deg) " + "scale3d(" + this.settings.scale + ", " + this.settings.scale + ", " + this.settings.scale + ")";
